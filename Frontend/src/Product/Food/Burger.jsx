        ...
        <div className="min-h-screen bg-stone-100 py-10 px-4 md:px-6">
            ...
            <div className="px-0 md:px-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
                ...
                <div className="bg-white shadow-lg rounded-xl overflow-hidden hover:scale-95 transition border border-b-black">
                    <img src={b1} className="w-full h-72 md:h-96 object-fit" />
                    <div className="p-4">
                        <h2 className="text-xl md:text-2xl font-bold">Korean Kimchi Veg Whopper</h2>
                        <p className="text-gray-800 text-sm md:text-base">The Korean Kimchi Paneer Burger is a popular, limited-time menu item from Burger King India.
                            It features a crispy paneer patty dunked in a sweet-and-spicy Korean glaze, and served on a toasted premium brioche bun</p>
                        <p className="text-gray-600 text-xl md:text-2xl font-bold">₹199/- </p>
                        {(() => {
                            const item = cart["b1"];
                            ...
                            return !item ? (
                                <button
                                    ...
                                    className="mt-4 flex items-center justify-center px-10 py-4 w-full text-xl font-bold text-amber-900 border rounded-lg"
                                >
                                    Add +
                                </button>
                            ) : (
                                <div className="mt-4 px-10 py-4 w-full flex items-center justify-center gap-4 bg-pink-100 rounded-lg">
                ...
                {/* Card 2 */}
                <div className="bg-white shadow-lg rounded-xl overflow-hidden hover:scale-95 transition border border-b-black">
                    <img src={b2} className="w-full h-72 md:h-96 object-fit" />
                    <div className="p-4">
                        <h2 className="text-xl md:text-2xl font-bold">Veg Makhni Burst Burger</h2>
                        <p className="text-gray-800 text-sm md:text-base"> A bold fusion of the classic Whopper with
                            authentic Korean flavor profiles. It is notoriously saucy, packed with heat,
                            and balanced by a tangy-sweet kimchi sauce. </p>
                        <p className="text-gray-600 text-xl md:text-2xl font-bold">₹69/- </p>
                        {(() => {
                            const item = cart["b2"];
                ...
                {/* Card 3 */}
                <div className="bg-white shadow-lg rounded-xl overflow-hidden hover:scale-95 transition border border-b-black">
                    <img src={b3} className="w-full h-72 md:h-96 object-cover" />
                    <div className="p-4">
                        <h2 className="text-xl md:text-2xl font-bold">Crispy Veg Double Patty</h2>
                        <p className="text-gray-800 text-sm md:text-base"> The Crispy Veg Double Patty is a fan-favorite,
                        ...
                        <p className="text-gray-600 text-xl md:text-2xl font-bold">₹89/- </p>
                        {(() => {
                            const item = cart["b3"];
                ...
                <div className="bg-white shadow-lg rounded-xl overflow-hidden hover:scale-95 transition border border-b-black">
                    <img src={b4} className="w-full h-72 md:h-96 object-fit" />
                    <div className="p-4">
                        <h2 className="text-xl md:text-2xl font-bold">Paneer Whopper Deluxe Meal</h2>
                        <p className="text-gray-800 text-sm md:text-base"> The Crispy Veg Double Patty is a fan-favorite,
                            budget-friendly burger featuring two crunchy, golden-fried vegetable
                            patties layered with fresh onions, creamy mayo, and signature sauces, all served in a soft premium bun </p>
                        <p className="text-gray-600 text-xl md:text-2xl font-bold">₹377/- </p>
                        {(() => {
                            const item = cart["b4"];
                ...
                <div className="bg-white shadow-lg rounded-xl overflow-hidden hover:scale-95 transition border border-b-black">
                    <img src={b5} className="w-full h-72 md:h-96 object-fit" />
                    <div className="p-4">
                        <h2 className="text-xl md:text-2xl font-bold">Crispy Veg Double Patty</h2>
                        <p className="text-gray-800 text-sm md:text-base"> The Crispy Veg Double Patty is a fan-favorite,
                            budget-friendly burger featuring two crunchy, golden-fried vegetable
                            patties layered with fresh onions, creamy mayo, and signature sauces, all served in a soft premium bun </p>
                        <p className="text-gray-600 text-xl md:text-2xl font-bold">₹500/- </p>
                        {(() => {
                            const item = cart["b5"];
                ...
                <div className="bg-white shadow-lg rounded-xl overflow-hidden hover:scale-90 transition border border-b-black">
                    <img src={br6} className="w-full h-72 md:h-96 object-fit" />
                    <div className="p-4">
                        <h2 className="text-xl md:text-2xl font-bold">BK Veg Meal For 2</h2>
                        <p className="text-gray-800 text-sm md:text-base"> The Crispy Veg Double Patty is a fan-favorite,
                            budget-friendly burger featuring two crunchy, golden-fried vegetable
                            patties layered with fresh onions, creamy mayo, and signature sauces, all served in a soft premium bun </p>
                        <p className="text-gray-600 text-xl md:text-2xl font-bold">₹707/- </p>
                        {(() => {
                            const item = cart["br6"];
