...
const Dominos = () => {
    ...
    return (
        <div className="min-h-screen bg-stone-100 py-10 px-4 md:px-6">
            ...
            <div className="px-0 md:px-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
                ...
                <div className="bg-white shadow-lg rounded-xl overflow-hidden hover:scale-95 transition border border-b-black flex flex-col">
                    <img src={pizza1} className="w-full h-72 md:h-[500px] object-cover" />
                    <div className="p-4 flex flex-col flex-1">
                        <h2 className="text-xl md:text-2xl font-bold">VEG EXTRAVAGANZA</h2>
                        <p className="text-gray-800 text-sm md:text-base"> Veg Extravaganza is a highly popular, fully loaded vegetarian pizza
                            premium offering curated by Domino's Pizza India.</p>
                        <p className="text-gray-600 text-xl md:text-2xl font-bold">₹309/-</p>
                ...
                {/* Card 2 */}
                <div className="bg-white shadow-lg rounded-xl overflow-hidden hover:scale-95 transition border border-b-black flex flex-col">
                    <img src={pizza2} className="w-full h-72 md:h-[500px] object-cover" />
                    <div className="p-4 flex flex-col flex-1">
                        <h2 className="text-xl md:text-2xl font-bold">FARM HOUSE</h2>
                        <p className="text-gray-800 text-sm md:text-base"> A pizza that goes ballistic on veggies! Check out this mouth watering overload of crunchy,
                            crisp capsicum, succulent mushrooms and fresh tomatoes</p>
                        <p className="text-gray-600 text-xl md:text-2xl font-bold">₹350/-</p>
                        {(() => {
                ...
                {/* Card 3 */}
                <div className="bg-white shadow-lg rounded-xl overflow-hidden hover:scale-95 transition border border-b-black flex flex-col">
                    <img src={pizza3} className="w-full h-72 md:h-[500px] object-cover" />
                    <div className="p-4 flex flex-col flex-1">
                        <h2 className="text-xl md:text-2xl font-bold">DELUXE VEGGIE</h2>
                        <p className="text-gray-800 text-sm md:text-base"> For a vegetarian looking for a BIG treat that goes easy on the spices,
                            this one's got it all.. The onions, the capsicum,
                            those delectable mushrooms - with paneer and golden corn to top it all.</p>
                        <p className="text-gray-600 text-xl md:text-2xl font-bold">₹400/-</p>
                        {(() => {
                ...
                <div className="bg-white shadow-lg rounded-xl overflow-hidden hover:scale-95 transition border border-b-black flex flex-col">
                    <img src={pizza4} className="w-full h-72 md:h-[500px] object-cover" />
                    <div className="p-4 flex flex-col flex-1">
                        <h2 className="text-xl md:text-2xl font-bold">Mexican Green Wave</h2>
                        <p className="text-gray-800 text-sm md:text-base">A pizza loaded with crunchy onions, crisp capsicum,
                            juicy tomatoes and jalapeno with a liberal sprinkling of exotic Mexican herbs. </p>
                        <p className="text-gray-600 text-xl md:text-2xl font-bold">₹399/-</p>
                        {(() => {
                ...
                <div className="bg-white shadow-lg rounded-xl overflow-hidden hover:scale-95 transition border border-b-black flex flex-col">
                    <img src={pizza5} className="w-full h-72 md:h-[500px] object-cover" />
                    <div className="p-4 flex flex-col flex-1">
                        <h2 className="text-xl md:text-2xl font-bold">CHEESE N CORN</h2>
                        <p className="text-gray-800 text-sm md:text-base"> Topped with shredded, crunchy green capsicum (bell peppers)
                            and liquid creamy cheese on a regular crust.</p>
                        <p className="text-gray-600 text-xl md:text-2xl font-bold">₹450/-</p>
                        {(() => {
                ...
                <div className="bg-white shadow-lg rounded-xl overflow-hidden hover:scale-95 transition border border-b-black flex flex-col">
                    <img src={pizza6} className="w-full h-72 md:h-[500px] object-cover" />
                    <div className="p-4 flex flex-col flex-1">
                        <h2 className="text-xl md:text-2xl font-bold">VEGGIE PARADISE</h2>
                        <p className="text-gray-800 text-sm md:text-base"> Topped with shredded, goldern Corn, Black Olives, Capsicum & Red Paprika crunchy green capsicum
                            and liquid creamy cheese on a regular crust.</p>
                        <p className="text-gray-600 text-xl md:text-2xl font-bold">₹549/-</p>
                        {(() => {
            ...
            {hasItems && (
                <div className="mt-10 bg-white p-4 md:p-6 rounded-xl shadow">
                    ...
                    <div className="mt-4 text-xl md:text-2xl font-bold text-right">
                        Total: ₹{
